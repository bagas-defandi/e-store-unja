    ...
    <main>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <section class="bg-white text-black px-5 py-6 rounded-lg mt-6 mb-4 md:mt-9">
                ...
                <div class="mt-14 grid gap-1">
                    <div
                        class="bg-gray-300 p-4 text-center text-sm md:text-base md:text-start md:flex md:items-center md:justify-between">
                        <div>
                            <p class="font-bold">Alif Tambunan</p>
                            <p>0852958454849ESTR001</p>
                        </div>
                        <a href="#"
                            class="font-bold text-amber-600 hover:underline hover:underline-offset-8">Lihat Detail
                            Pembelian</a>
                    </div>
                    <div
                        class="bg-gray-300 p-4 text-center text-sm md:text-base md:text-start md:flex md:items-center md:justify-between">
                        <div>
                            <p class="font-bold">Adib Yasykur</p>
                            <p>0852483943593ESTR001</p>
                        </div>
                        <a href="#"
                            class="font-bold text-amber-600 hover:underline hover:underline-offset-8">Lihat Detail
                            Pembelian</a>
                    ...
                    <div
                        class="bg-gray-300 p-4 text-center text-sm md:text-base md:text-start md:flex md:items-center md:justify-between">
                        <div>
                            <p class="font-bold">Bagas Defandi</p>
                            <p>0852750585747ESTR001</p>
                        </div>
                        <a href="#"
                            class="font-bold text-amber-600 hover:underline hover:underline-offset-8">Lihat Detail
                            Pembelian</a>
                    ...
                    <div
                        class="bg-gray-300 p-4 text-center text-sm md:text-base md:text-start md:flex md:items-center md:justify-between">
                        <div>
                            <p class="font-bold">Andri Yano</p>
                            <p>0852024348348ESTR001</p>
                        </div>
                        <a href="#"
                            class="font-bold text-amber-600 hover:underline hover:underline-offset-8">Lihat Detail
                            Pembelian</a>
