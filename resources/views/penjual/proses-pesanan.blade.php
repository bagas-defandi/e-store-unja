...
<body>
    ...
    <main>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <section class="bg-white text-black md:px-5 py-6 rounded-lg mt-6 mb-4 md:mt-9">
                <h2 class="text-xl font-bold pb-1 mb-4 lg:mb-10 mx-3 md:mx-0">SiniMakan : Aldi Sukma Putra</h2>
                ...
                <div class="mt-14 bg-gray-300 ff-raleway py-7 px-4 md:py-9 md:px-14">
                    <div class="grid gap-4">
                        <div class="bg-white p-3 rounded grid md:grid-cols-4">
                            <div
                                class="flex items-center gap-2 py-6 md:py-0 justify-self-center md:col-span-3 md:justify-self-start w-full">
                                <img class="product rounded-lg" src="../img/product-1.jpg" alt="">
                                <div style="height: 77px" class="flex flex-col flex-grow justify-center">
                                    <p class="text-sm sm:text-base font-medium text-black self-start">
                                    ...
                                    <div class="flex justify-between mt-2.5">
                                        ...
                                        <p class="text-sm sm:text-base font-bold mt-auto">Rp3000</p>
                                    </div>
                                </div>
                            </div>
                            <div class="grid justify-center self-center">
                                <a class="inline-block text-sm font-bold rounded-md bg-amber-400 py-3 text-white px-10 md:px-3 lg:px-10 hover:bg-amber-500 md:h-min"
                                    href="#">Terima Pesanan
                                </a>
                            </div>
                        </div>
