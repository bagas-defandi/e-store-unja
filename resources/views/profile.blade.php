...
<body>
    ...
    <main>
        <section class="max-w-7xl mx-auto ff-raleway px-4 mb-5">
            <div class="bg-white grid gap-8 md:grid-cols-2 rounded-lg mt-20 sm:px-6 md:py-10 lg:p-32">
                <div
                    class="order-1 grid gap-6 text-center mt-4 md:text-start md:h-min md:pt-8 md:pl-20 md:gap-9 lg:text-xl">
                    <div>
                        <p class="font-semibold">Nama</p>
                        <p>Adib Yasykur Rizkillah</p>
                    </div>
                    <div>
                ...
                <div class="grid justify-items-center text-center md:order-2 lg:justify-end">
                    <img src="./img/profile-big.png" alt="">
                    <a class="font-medium border-2 border-black rounded-md py-3 px-16 hover:bg-black hover:text-white"
                        href="#">Ubah
                        Foto</a>
                </div>
            </div>
